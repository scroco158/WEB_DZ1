    ...
    <div class="container">
        ...
        <main class="row">
            <div class="row text-center">
                      ...
                      <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="mb-3">
                                  ...
                                  <button type="button" class="w-100 btn btn-lg btn btn-success">Отправить</button>
                            </form>
                ...
                <h3 class="card_header">F A Q</h3>

                 <p class="d-inline-flex gap-1">
                              <button  class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample1"  aria-expanded="false"  aria-controls="multiCollapseExample2">Как купить?</button>
                              <button  class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2"  aria-expanded="false"  aria-controls="multiCollapseExample3">Как доставить?</button>
